...
public class PanelMenuSauvegardes extends PanelEtat {
    ...
    public PanelMenuSauvegardes(ControleurMediateur ctrl, InterfaceGraphique vue, Programme prog) {
        ...
        add(Box.createGlue(), new GridBagConstraints(0, 0, 1, 1, 0.33, 1.0 / (Programme.NB_SAUVEGARDES+4), GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        add(Box.createGlue(), new GridBagConstraints(1, 0, 1, 1, 0.30, 1.0 / (Programme.NB_SAUVEGARDES+4), GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        ...
        add(Box.createGlue(), new GridBagConstraints(1, 4+Programme.NB_SAUVEGARDES, 1, 1, 0.30, 1.0 / (Programme.NB_SAUVEGARDES+4), GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        for (int i = 0; i < Programme.NB_SAUVEGARDES; i++)
        ...
        add(Box.createGlue(), new GridBagConstraints(3, 0, 1, 1, 0.33, 1.0 / (Programme.NB_SAUVEGARDES+4), GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    }
